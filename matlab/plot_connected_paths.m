...
figure()
subplot(3,1,1)
plot([fliplr(max_connected_path_90deg_ext),max_connected_path_90deg_unconf,max_connected_path_90deg_comp],'.--')
xlim([1,9])
ylim([0.1,1])
...
subplot(3,1,2)
plot([fliplr(max_connected_path_45deg_ext),max_connected_path_45deg_unconf,max_connected_path_45deg_comp],'.--')
xlim([1,9])
ylim([0.1,1])
...
subplot(3,1,3)
plot([fliplr(max_connected_path_15deg_ext),max_connected_path_15deg_unconf,max_connected_path_15deg_comp],'.--')
xlim([1,9])
ylim([0.1,1])
